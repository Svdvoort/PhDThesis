...
\includepdf[pages=1,pagecommand={\thispagestyle{empty}\chapter[The Erasmus Glioma Database (EGD): Structural MRI scans, WHO 2016 subtypes, and segmentations of 774 patients with glioma][Erasmus Glioma Database]{}\label{chap:EGD}}, fitpaper=true]{Title_page.pdf}

...
We segmented preoperative and postoperative glioma lesions on \cgls{MR} imaging in a semi-automated fashion with the SmartBrush tool that is incorporated in Brainlab Elements (version 2.1.0.15).
...
Twenty-two patients were excluded: 16 due to sequencing failure, 2 due to a preoperative contrast enhancement suggestive of \gls{glioblastoma}, and another 4 due to insufficient image quality
Of the remaining 224 patients, 110 were \cgls{IDH} mutated \glspl{astro}, 92 were \glspl{oli}, and 22 were \cgls{IDH} wildtype \glspl{astro}.
...
With \cgls{IDH} wildtype \glspl{astro} as reference category, our analysis indicated that \cgls{IDH} wildtype \glspl{astro} are more frequently located in the basal ganglia of the right hemisphere (when compared with \cgls{IDH}-mutated \cglspl{LGG}) (\cref{fig:LGG_location_P_values}B).
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{Oligodendroglioma, IDH mutated 1p/19q co-deleted (N=92)}\label{fig:LGG_location_heatmap_IDH_mut_1p19q_codel}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{
        ...
        \caption{Astrocytoma, IDH mutated (N=110)}\label{fig:LGG_location_heatmap_IDH_mut_1p19q_intact}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{
        ...
        \caption{Astrocytoma, IDH wildtype (N=22)}\label{fig:LGG_location_heatmap_IDH_intact_1p19q_intact}
    \end{subfigure}
    ...
    \refsubfigure{fig:LGG_location_heatmap_IDH_mut_1p19q_intact} \acrshort{IDH}-mutated \gls{astro} shows a distribution with most \glspl{tumor} located in or near the insular region.
    \refsubfigure{fig:LGG_location_heatmap_IDH_intact_1p19q_intact} \acrshort{IDH} wildtype \glspl{astro} are more often located in midline region and basal
...
\begin{figure}
    ...
    \caption{Differences in location distribution between \cgls{IDH} wildtype and mutated \acrlongpl{LGG}. Voxel-color indicates corrected P-value with
    color bar for scale;
    \refsubfigure{fig:LGG_location_p_values_IDH_mut_vs_IDH_wt_mutated} regions more often occupied by \cgls{IDH}-mutated \acrlongpl{LGG};
    \refsubfigure{fig:LGG_location_p_values_IDH_mut_vs_IDH_wt_wt} regions more often occupied by \cgls{IDH} wildtype \acrlongpl{LGG}}\label{fig:LGG_location_P_values}
\end{figure}


Direct comparison between \cgls{IDH}-mutated \glspl{astro} and \glspl{oli} showed a small area in the left frontal cortex where \glspl{oli} occurred significantly more frequently (P $<$ 0.05), and a small region in the right temporal lobe where \cgls{IDH} mutated \glspl{astro} (\cref{fig:LGG_location_oligo_astro_p_value}) occurred more frequently.
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Results of the FSL Randomize test with \num{15000} permutations for statistical
    differences in location distribution. The color of a voxel is correlated with
    a p-value as indicated in the top-right color bar;
    \refsubfigure{fig:LGG_location_p_values_1p19q_codeleted_vs_intact_codeleted} heatmap of unique localizations for \gls{oli} compared with \acrshort{IDH} mutated \glspl{astro};
    \refsubfigure{fig:LGG_location_p_values_1p19q_codeleted_vs_intact_intact} heatmap of unique localizations for \acrshort{IDH} mutated \glspl{astro}
    compared with \glspl{oli}}\label{fig:LGG_location_oligo_astro_p_value}
\end{figure}
...
In \cgls{IDH}-mutated \gls{astro}, we created heatmaps of loss of chromosomal arm 9p and imbalance of chromosome 7, and found no preferential brain locations/voxels for either of those that showed P-values $<$0.05 (\cref{fig:LGG_location_heatmap_chromosome_7_9}).
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{\acrshort{IDH} mutated 1p/19q co-deleted \gls{oli}, CIC mutated (N=XXX)}\label{fig:LGG_location_heatmap_oli_cic_mutated}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_CIC_wt.pgf}
        }
        \caption{\acrshort{IDH} mutated 1p/19q co-deleted \gls{oli}, CIC wildtype (N=XXX)}\label{fig:LGG_location_heatmap_oli_cic_wt}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_FUBP_mut.pgf}
        }
        \caption{\acrshort{IDH} mutated 1p/19q co-deleted \gls{oli}, FUBP1 mutated (N=XXX)}\label{fig:LGG_location_heatmap_oli_fubp_mutated}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_9p_loss_loss.pgf}
        }
        \caption{\acrshort{IDH} mutated 1p/19q co-deleted \gls{oli}, loss 9p (N=XXX)}\label{fig:LGG_location_heatmap_oli_9p_loss}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_9p_loss_intact.pgf}
        }
        \caption{\acrshort{IDH} mutated 1p/19q co-deleted \gls{oli}, 9p intact (N=XXX)}\label{fig:LGG_location_heatmap_oli_9p_intact}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \caption{Results of the FSL Randomize test showing unique localizations for loss of 9p in the context of \gls{oli}}\label{fig:LGG_location_p_value_9p}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{\acrshort{IDH} mutated \gls{astro}, imbalance chromosome 7 (N=XXX)}\label{fig:LGG_location_heatmap_astro_chr_7_imbalance}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_IDH_mutated_astro_7_intact.pgf}
        }
        \caption{\acrshort{IDH} mutated \gls{astro}, chromosome 7 intact (N=XXX)}\label{fig:LGG_location_heatmap_astro_chr_7_intact}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_IDH_mutated_chro9_loss.pgf}
        }
        \caption{\acrshort{IDH} mutated \gls{astro}, loss 9p (N=XXX)}\label{fig:LGG_location_heatmap_astro_chr_9_loss}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \resizebox{\textwidth}{!}{
            \subimport{Figures/}{heatmap_IDH_mutated_chro9_intact.pgf}
        }
        \caption{\acrshort{IDH} mutated \gls{astro}, 9p intact (N=XXX)}\label{fig:LGG_location_heatmap_astro_chr_9_intact}
    \end{subfigure}
...
\begin{subfigure}[b]{\textwidth}
    ...
    \caption{\SI{0.0}{\cubic\centi\metre} postoperative \gls{tumor} volume (N=XXX)}\label{fig:LGG_location_heatmap_postop_0}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
    \resizebox{\textwidth}{!}{
        \subimport{Figures/}{heatmap_postop_01_50.pgf}
    }
    \caption{\SIrange{0.0}{5.0}{\cubic\centi\metre} postoperative \gls{tumor} volume (N=XXX)}\label{fig:LGG_location_heatmap_postop_01_50}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
    \resizebox{\textwidth}{!}{
        \subimport{Figures/}{heatmap_postop_51_150.pgf}
    }
    \caption{\SIrange{5.1}{15.0}{\cubic\centi\metre} postoperative \gls{tumor} volume (N=XXX)}\label{fig:LGG_location_heatmap_postop_51_150}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
    \resizebox{\textwidth}{!}{
        \subimport{Figures/}{heatmap_postop_150.pgf}
    }
    \caption{\SI{>15.0}{\cubic\centi\metre} postoperative \gls{tumor} volume (N=XXX)}\label{fig:LGG_location_heatmap_postop_150}
\end{subfigure}
...
indicate the frequencies corresponding with the color of the voxels;
\refsubfigure{fig:LGG_location_heatmap_postop_0} \glspl{glioma} with a total resection (\SI{0.0}{\cubic\centi\metre} residue);
\refsubfigure{fig:LGG_location_heatmap_postop_01_50} \glspl{glioma} with a postoperative \gls{tumor} volume of \SIrange{0.1}{5.0}{\cubic\centi\metre};
\refsubfigure{fig:LGG_location_heatmap_postop_51_150} \glspl{glioma} with a postoperative \gls{tumor} volume of  \SIrange{5.1}{15.0}{\cubic\centi\metre};
\refsubfigure{fig:LGG_location_heatmap_postop_150} \glspl{glioma} with a postoperative \gls{tumor} volume
...
A current hot topic in glioma research is the development of noninvasive prediction of \cgls{WHO} 2016 classification of \gls{tumor} diagnosis based on preoperative \cgls{MR} scans.
...
However, our aim was not to find subtle differences, but clinically relevant differences between groups, and our cohort with heterogeneous \cgls{MR} protocols is sufficient for this aim (and also reflects the \say{real-life} situation).

...
{\chapquote{WHO 2016 subtyping and automated segmentation of glioma using multi-task deep learning}{\say{Of course it is all happening inside your head, but why on earth should that mean that it is not real?} -- JK Rowling, Harry Potter and the Deathly Hallows}

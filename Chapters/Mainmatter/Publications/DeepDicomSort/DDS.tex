...
\includepdf[pages=1,pagecommand={\thispagestyle{empty}\chapter[DeepDicomSort: An automatic sorting algorithm for brain magnetic resonance imaging data][DeepDicomSort: Automatic sorting of brain MRI data]{}\label{chap:DDS}}, fitpaper=true]{Title_page.pdf}

...
The \gls{BTtest} contained 2369 \glspl{scan} of 302 different \glspl{ses} from 192 \glspl{sub}.
...
\begin{table}[htbp]
    ...
    \toprule
     &\multicolumn{5}{c}{\textbf{\Gls{BTtrain}}}&&\multicolumn{5}{c}{\textbf{\Gls{BTtest}}}\\
...
In order to evaluate the results of the algorithm on non-tumor brain imaging, we used the \gls{ADNI} \gls{ds} (\url{adni.loni.usc.edu}).
...
We used the baseline and screening data of 1318 \glspl{sub}, resulting in 7227 \glspl{scan}.
These \glspl{scan} originated from 67 different \glspl{site} and were acquired on 23 different scanner models from 3 different vendors (GE, Philips, and Siemens).
...
These \gls{ASL} derived maps explain the 47 3D \glspl{scan} in \cref{tab:data_adni}.
...
\begin{table}[htbp]
    ...
    \toprule
     &\multicolumn{5}{c}{\textbf{\gls{NTTS}}}\\
    \cmidrule(l){2-6}
...
After applying these pre-processing steps, the \gls{BTtrain} consisted of 276625 \glspl{sample}, the \gls{BTtest} consisted of 59225 \glspl{sample}, and the \gls{NTTS} consisted of 180675 \glspl{sample}.
...
\begin{table}[ht]
 ...
 \setlength{\tabcolsep}{2pt}
  ...
  \begin{tabular}{lr C{1.1cm} C{1.1cm} C{1.1cm} C{1.1cm} C{1.1cm} C{1.1cm} C{1.1cm} C{1.1cm}}
    \multirow{7}{*}{\bfseries \raggedleft \rotatebox{90}{Ground truth\hspace{4em}}}&
  \multicolumn{8}{c}{{\bfseries \hspace{8em} Predicted}}\\
  \cmidrule(lr){3-10}
 & & \textit{\gls{T1}} & \textit{\gls{T1C}} & \textit{\gls{T2}} & \textit{\gls{PD}} & \textit{\gls{FLAIR}} & \textit{\gls{DWI}} & \textit{\gls{DSC}} & \textit{Derived}\\
 &\multicolumn{1}{|c}{\textit{\gls{T1}}}          & 433  & 2    & 0     & 1     & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{T1C}}}         & 2    & 608  & 0     & 0     & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{T2}}}          & 1    & 2    & 292   & 0     & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{PD}}}          & 0    & 0    & 0     & 181   & 0     & 0     & 0   & 0 \\
 &\multicolumn{1}{|c}{\textit{\gls{FLAIR}}}    & 18   & 0    & 0     & 0     & 238   & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{DWI}}}          & 0    & 0    & 0     & 0     & 0     & 344   & 2   & 1 \\
 &\multicolumn{1}{|c}{\textit{\gls{DSC}}}      & 0    & 0    & 0     & 0     & 0     & 0     & 87 & 0 \\
 &\multicolumn{1}{|c}{\textit{Derived}}      & 0    & 0    & 1     & 0     & 0     & 0     & 0   & 156\\
  \end{tabular}
\end{table}
...
\begin{table}[ht]
 ...
 \setlength{\tabcolsep}{2pt}
  ...
  \cmidrule(lr){3-10}
 & & \textit{\gls{T1}} & \textit{\gls{T1C}} & \textit{\gls{T2}} & \textit{\gls{PD}} & \textit{\gls{FLAIR}} & \textit{\gls{DWI}} & \textit{\gls{DSC}} & \textit{Derived}\\
 &\multicolumn{1}{|c}{\textit{\gls{T1}}}          & 2655  & 1    & 0    & 0     & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{T1C}}}         & 0    & 0    & 0     & 0     & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{T2}}}          & 0    & 34   & 2140  & 44    & 0     & 0     & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{PD}}}          & 0    & 0    & 2     & 1067  & 0     & 0     & 0   & 0 \\
 &\multicolumn{1}{|c}{\textit{\gls{FLAIR}}}    & 6    & 5    & 0     & 1     & 468   & 12    & 0   & 0\\
 &\multicolumn{1}{|c}{\textit{\gls{DWI}}}          & 0    & 0    & 0     & 0     & 0     & 557   & 3   & 0 \\
 &\multicolumn{1}{|c}{\textit{\gls{DSC}}}      & 0    & 0    & 0     & 0     & 0     & 0     & 0   & 0 \\
 &\multicolumn{1}{|c}{\textit{Derived}}      & 0    & 0    & 1     & 0     & 0     & 3     & 0    & 228\\
  \end{tabular}
\end{table}

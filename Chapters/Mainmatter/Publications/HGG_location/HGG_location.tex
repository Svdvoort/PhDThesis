...
\begin{subappendices}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_all_T1/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_all_T2/slice-68.png}
            \fi
        ...
        \else
            \caption{Single slice of location heatmaps of the \glspl{tumor} for all patients. Animated scroll-throughs are available in the digital version of this thesis}\label{fig:HGG_local_heatmaps_full_all}
        \fi
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_methylated_T1/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_methylated_T2/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_unmethylated_T1/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/heatmaps_unmethylated_T2/slice-68.png}
            \fi
        ...
        \else
            \caption{Single slice of location heatmaps of the \glspl{tumor} for the MGMT methylated and MGMT unmethylated subgroups. Animated scroll-throughs are available in the digital version of this thesis}\label{fig:HGG_local_heatmaps_subgroups}
        \fi
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \else
            \includegraphics[width=\textwidth]{Figures/Animation/frequency_maps_T1/slice-68.png}
        \fi
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \else
            \includegraphics[width=\textwidth]{Figures/Animation/frequency_maps_T2/slice-68.png}
        \fi
    ...
    \else
        \caption{Single slice of the frequency difference maps between \gls{MGMT} methylated and \gls{MGMT} unmethylated \gls{GBM}. Animated scroll-throughs are available in the digital version of this thesis}\label{fig:HGG_loc_freq_map_full}
    \fi
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/p_value_T1_methylated/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/p_value_T2_methylated/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/p_value_T1_unmethylated/slice-68.png}
            \fi
        ...
        \begin{subfigure}[t]{0.4\textwidth}
            ...
            \else
                \includegraphics[width=\textwidth]{Figures/Animation/p_value_T2_unmethylated/slice-68.png}
            \fi
        ...
        \else
            \caption{Single slice of the p-value maps of the \glspl{tumor}. Animated scroll-throughs are available in the digital version of this thesis}\label{fig:HGG_loc_p_value_map_full}
        \fi

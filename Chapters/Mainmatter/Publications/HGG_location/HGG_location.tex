...
\chapter[Topographical Mapping of 436 Newly Diagnosed IDH Wildtype Glioblastoma With vs. Without MGMT Promoter Methylation][HGG MGMT topographical mapping]{Topographical Mapping of 436 Newly Diagnosed IDH Wildtype Glioblastoma With vs. Without MGMT Promoter Methylation}\label{chap:HGGLocation}
...
\begin{ChapterAbstract}
    ...
    \Glspl{tumor} were semi-automatically segmented, and the topographical distribution between glioblastoma with vs. without \cgls{MGMT} promoter methylation was visualized using frequency heatmaps.
...
Therefore, patients with \cgls{MGMT} methylated glioblastoma are more sensitive to neo-adjuvant temozolomide than those without \cgls{MGMT} methylated glioblastoma.
...
%     }
% \begin{tabular}{L{5cm} S[table-number-alignment=center-decimal-marker, table-format=2.1] S[table-number-alignment=center-decimal-marker, table-format=2.1]   S[table-number-alignment=center-decimal-marker, table-format=2.1]  S[table-number-alignment=center-decimal-marker, table-format=2.1] S[table-number-alignment=center-decimal-marker, table-format=0.3]}
%     \toprule
%     {\textbf{Preoperative \gls{tumor} volume}}& \multicolumn{2}{c}{\thead{MGMT promoter}}\\
%     \cmidrule{2-3}
%      & {Methylated} & {Unmethylated} & {p-value}\\
%      & {211 (\per{48.4})} & {255 (\per{51.6})}\\
%     \midrule
%     % Need to fix this for the IQR
%     Contrast-enhancing & \IQR{30.1}{39.5} & \IQR{35}{45.8} & \num{0.130}\\
%     Non-enhancing & \IQR{75.5}{105.0} & \IQR{65.5}{84.2} & \num{0.338}\\
%     Non-enhancing/contrast-enhancing ratio & \IQR{2.5}{3.3} & \IQR{2.09}{2.6} & \num{0.045}\\
%     \bottomrule
% \end{tabular}
% \caption{Preoperative \gls{tumor} volume of different subgroups. Abbreviations: \acrcaption{IQR}}\label{tab:HGG_location_tumor_characteristics}
% \end{table}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_all_T1.pgf}}
    \caption{Distribution of \glspl{tumor} segmented on  the \gls{T1C} scan}\label{fig:HGG_location_heatmap_all_T1}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_all_T2.pgf}}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_methylated_T1.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_methylated_T2.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_unmethylated_T1.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{heatmap_unmethylated_T2.pgf}}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{frequency_map_T1.pgf}}
        \caption{Frequency map of \glspl{tumor} segmented on  the \gls{T1C} scan}\label{fig:HGG_location_frequency_T1}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{frequency_map_T2.pgf}}
...
\cref{fig:HGG_location_pvalue_map} in fact shows that not any statistically significantly discriminating brain area between \gls{MGMT} methylated and unmethylated glioblastoma could be found (\pvalue{< 0.05}).
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{p_value_T1_methylated.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{p_value_T2_methylated.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{p_value_T1_unmethylated.pgf}}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\subimport{Figures/}{p_value_T2_unmethylated.pgf}}
...
This hypothesis was recently supported by \citeauthorref{roux2019mri}, who assessed a homogenous \gls{IDH} wildtype glioblastoma population (\numbersamples{= 392}) and found no difference in localization between glioblastoma with and without \gls{MGMT} methylation, in line with our study.

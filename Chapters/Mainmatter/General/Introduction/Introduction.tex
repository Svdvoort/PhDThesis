...
\begin{figure}[htbp]
    ...
    The machine learning model learns the characteristic scan appearance of each category based on scans from patients for which the clinical outcome is known.
    Scans of patients for which the clinical outcome is not yet known are evaluated by the model, which then predicts the likely clinical outcome.}\label{fig:intro_example_ml}
\end{figure}

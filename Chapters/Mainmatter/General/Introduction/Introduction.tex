...
\epigraphhead[450]{\epigraph{\say{The Wheel of Time turns, and ages come and pass, leaving memories that become legend.
Legend fades to myth, and even myth is long forgotten when the Age that gave it birth comes again.
In one Age, called the Third Age by some, an Age yet to come, an Age long past, a wind rose along the Erasmus Bridge.
The wind was not the beginning. There are neither beginnings nor endings to the turning of the Wheel of time.
But it was a beginning.}}{--- \textup{Robert Jordan}, The Wheel of Time}}
...
This categorization based on \gls{tumor} typing and grading is suboptimal.
...
In the updated guidelines, \gls{glioma} typing has become less relevant.
...
This need for new imaging markers has caused a rise in popularity of automated analysis methods, most notably machine learning methods.
...
\begin{figure}[htbp]
    \centering
    \resizebox{0.93\textwidth}{!}{\subimport{Figures/}{Machine_learning_pipeline.pgf}}
